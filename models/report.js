 ...
 *
 * poster: The ObjectId of the UserAuth of the user who posted this report.
 * posted: The Date when this report was posted.
 * posted_from: The location where this report was posted from.
 * upvoters: An array of ObjectIds of the UserAuths of the users who upvoted this report.
 * downvoters: An array of ObjectIds of the UserAuths of the users who downvoted this report.
...
var ReportSchema = mongoose.Schema({
  poster: {type: mongoose.Schema.Types.ObjectId, ref: 'UserAuth'},
  posted: {type: Date, default: Date.now},
  posted_from: location: {type: [Number], index: '2dsphere'},
  upvoters: [{type: mongoose.Schema.Types.ObjectId, ref: "UserAuth"}],
  downvoters: [{type: mongoose.Schema.Types.ObjectId, ref: "UserAuth"}],
